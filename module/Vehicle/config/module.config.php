...
return array(
        ...
        'routes' => array(
            'vehicle' => array(
                ...
                'options' => array(
                    'route'    => '/vehicle',
                    'defaults' => array(
                        'controller' => 'Vehicle\Controller\Index',
                        'action'     => 'index',
                    ),
                ),
            ),
            ...
            'Vehicle' => array(
                ...
                'options' => array(
                    'route'    => '/vehicle',
                    'defaults' => array(
                        '__NAMESPACE__' => 'Vehicle\Controller',
                        'controller'    => 'Index',
                        'action'        => 'index',
                    ),
                ),
    ...
    'controllers' => array(
        'invokables' => array(
            ...
            'Vehicle\Controller\Index' => 'Vehicle\Controller\IndexController',
    ...
    'view_manager' => array(
        ...
        'template_map' => array(
            ...
            'vehicle/index/index' => __DIR__ . '/../view/vehicle/index/index.phtml',
	...
	'user' => array(
		...
		'options' => array(
			'route' => '/api/user/[/:id]',
			'default' => array(
			'controller' => 'Vehicle\Controller\user',
			),
		),
	),
