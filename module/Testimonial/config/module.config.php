...
return array(
        ...
        'routes' => array(
            'testimonial' => array(
                ...
                'options' => array(
                    'route'    => '/testimonial',
                    'defaults' => array(
                        'controller' => 'Testimonial\Controller\Index',
                        'action'     => 'index',
                    ),
                ),
            ),
    ...
    'controllers' => array(
        'invokables' => array(
            ...
            'Testimonial\Controller\Index' => 'Testimonial\Controller\IndexController',
    ...
    'view_manager' => array(
        ...
        'template_map' => array(
            ...
            'testimonial/index/index' => __DIR__ . '/../view/testimonial/index/index.phtml',
	...
	'user' => array(
		...
		'options' => array(
			'route' => '/api/user/[/:id]',
			'default' => array(
			'controller' => 'Testimonial\Controller\user',
			),
		),
	),
