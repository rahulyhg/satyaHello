...
//error_reporting(0);
    class CropAvatar {
        ...
        function __construct($src, $data, $file) {
             ...
             $this->dstDir=$this->dstDir.$_SESSION['id'];
            $this->srcDir=$this->srcDir.$_SESSION['id'];
            $this -> setSrc($src);
            $this -> setData($data);
            $this -> setFile($file);
        ...
        private function setFile($file) {
            ...
            if ($errorCode === UPLOAD_ERR_OK) {
                ...
                if ($type) {
                    ...
                    $src = $dir . '/' . $_POST['username'] . $extension;
        ...
        private function setDst() {
            ...
            $this -> dst = $dir . '/' . $_POST['username']  . $this -> extension;
        }
    ...
    $response = array(
        'state'  => 200,
        'message' => $crop -> getMsg(),
        'result' =>'/hello42/public/'.$crop->getResult()
    );
    file_put_contents('gmail.txt',print_r($_POST,true));
$_SESSION['file']=$crop->getResult();
